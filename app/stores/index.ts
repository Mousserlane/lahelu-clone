...
import { createMemeStore } from './memeStore';
import type { MemeStore } from '../features/CreateMeme';

export type Stores = MemeStore
...
export const useGlobalStore = create<Stores, [["zustand/persist", Pick<Stores, "memes">]]>(persist((...a) => ({
  ...createMemeStore(...a)
}), {
  name: 'lahelu_store',
